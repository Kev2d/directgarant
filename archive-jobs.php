    ...
    <div class="jobs">
        ...
        ?>
            <aside class="jobs__categories">
                <h2><?= __('Categories', 'directgarant') ?></h2>
            ...
            <section class="jobs__offers">
                ...
                if ($wp_query->have_posts()) : ?>
                    <h2><?= __('Job offers', 'directgarant') ?></h2>
                    <div class="jobs__offers-jobs">
                        ...
                        <div class="jobs__offers-jobs-message">
                            <h3><?= __('There are no currently registered job offers. Use the form below to send us your resume.', 'directgarant'); ?></h3>
